...
// 		}
	...
	public function test_public_key( $key = null ) {
		...
		$pub_key_url = sprintf( "http://www.recaptcha.net/recaptcha/api/challenge?k=%s" , $key );
	...
	public function test_private_key( $key = null ) {
		...
		$prv_key_url = sprintf( "http://www.recaptcha.net/recaptcha/api/verify?privatekey=%s" , $key );
